            ...
            <div class="templatemo-content" style="border-left:1px solid #ddd ">
                    ...
                    <table class="table table-striped table-hover table-bordered">
                        ...
                        while ($res = $result->fetch(PDO::FETCH_OBJ)) {
                            ...
                            <tr>
                                ...
                                <td><?= $res->date; ?></td>
                                <td><a href="./tech_edit.php?id=<?= $res->id; ?>" class="btn btn-default">编辑</a>
                                </td>
                                <td><a href="./sql/deleteTech.php?id=<?= $res->id; ?>" class="btn btn-primary" onclick="confirm('确定要删除吗？')">删除</a></td>
                            </tr>
                        <?php } ?>
                        </tbody>
                    </table>
                ...
                <div class="modal-footer">
                    <ul class="pagination pull-left">
                        <li class="active">
                            <a href="tech_add.php" class="btn btn-primary" style="cursor: pointer">添加</a>
                        </li>
                    </ul>
