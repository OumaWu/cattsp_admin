                ...
                <form id="form1" name="form1" method="post" action="./sql/insertExpert.php"
                    ...
                    <table width="100%" border="0" cellpadding="6" cellspacing="0" class="grid">
                        ...
                        <tr>
                            ...
                            <td><input name="career_age" value="<?=$res->career_age;?>" type="text" id="career_age" size="60"/></td>
                        </tr>
                        <tr>
                            <th width="120" align="right">学历：</th>
                            <td><input name="degree" value="<?=$res->degree;?>" type="text" id="degree" size="60"/></td>
                        </tr>
                        <tr>
                            <th width="120" align="right">毕业院校：</th>
                            <td><input name="institute" value="<?=$res->institute;?>" type="text" id="institute" size="60"/></td>
                        </tr>
                        <tr>
                            <th width="120" align="right">从事领域：</th>
                            <td><input name="domain" value="<?=$res->domain;?>" type="text" id="domain" size="60"/></td>
                        </tr>
                        <tr>
                            <th width="120" align="right">擅长专业：</th>
                            <td><input name="speciality" value="<?=$res->speciality;?>" type="text" id="speciality" size="60"/></td>
                        </tr>
                        <tr>
